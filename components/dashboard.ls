...
module.exports = React.create-class do
  render: ->
    div null,
      ...
      p null, "Baseline supports Mac OS X and Linux hosts, and bundles Ruby 2.0"
      ...
      p null, "Start real-time, continuous monitoring of your service"
      pre null, "baseline-agent start <service-name>.rb"
      h3 null, "Step 5 - View"
      p null, "Select your service dashboard from the top navigation menu, and view real-time status checks and service diagrams."
